...
const SOURCE_REVIEW_QUEUE = [
  ...
  ["install_unit", "install_unit:acme.pack", "Source is enabled but not reviewed.", "high", null],
...
function reviewQueueEntry([kind, id, reason, risk, severity]) {
  const advanced = severity === null
    ? { install_unit: "acme.pack", source_class: "external-package", trust_level: "unreviewed" }
